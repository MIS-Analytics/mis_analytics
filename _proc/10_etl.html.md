---
description: Helper to make ETL pipelines easier.
output-file: etl.html
title: ETL
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L17){target="_blank" style="float:right; font-size:smaller"}
...
So we are thinking of a hybrid of 2 and 3). So we would write a decorator that adds a logging keyword to each function, then we can determine for each function in the pipeline what to log/how much to log. We want to keep it as simple as possible. The pipeline should just take a df and a list of functions as steps of the pipeline.
...
Good question! There isn't a built-in method for `timedelta` to auto-format based on magnitude, but you can write a simple helper function. Here's a compact approach:
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L32){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L41){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L44){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L51){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L55){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L65){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L75){target="_blank" style="float:right; font-size:smaller"}
...
Here's how to combine it into one f-string:
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L80){target="_blank" style="float:right; font-size:smaller"}
...
Here's a combined function that uses all the display functions you've created:
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L102){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L113){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/MIS-Analytics/mis_core/blob/main/mis_core/etl.py#L122){target="_blank" style="float:right; font-size:smaller"}
