...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L20"
...
```
    ...
    datetime.timedelta(seconds=3, microseconds=140759)

``` python
start_time
```

    datetime.datetime(2026, 9, 14, 12, 30, 41, 547669)
...
```
    ...
    ********** Step: filter_products **********
    ...
    Input DataFrame shape: (5, 5)
    Start time: 2026-09-14 12:30:44.757964
       order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150
    ...
    Output DataFrame shape: (4, 5)
    End time: 2026-09-14 12:30:44.759521
    Total time: 0:00:00.001557
       order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150
    ...
    ********** Step: aggregate_by_product **********
    ...
    Start time: 2026-09-14 12:30:44.760193
       order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150
    ...
    End time: 2026-09-14 12:30:44.763016
    Total time: 0:00:00.002823
...
```
    ...
    {'step_name': 'filter_products', 'in_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 823024), 'in_df_shape': (5, 5), 'in_df_head':    order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    ...
    2       103  Widget A        75        3              150
    3       104  Widget C        20        0               80
    4       105  Widget B        45        2              110, 'out_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 824010), 'out_df_shape': (4, 5), 'out_df_head':    order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    ...
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150
    4       105  Widget B        45        2              110, 'total_time': datetime.timedelta(microseconds=983)}
    Here we use a fuction to display the information
    {'step_name': 'aggregate_by_product', 'in_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 830224), 'in_df_shape': (4, 5), 'in_df_head':    order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150, 'in_df_sample':    order_id   product  quantity  defects  production_time
    2       103  Widget A        75        3              150
    ...
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150
    4       105  Widget B        45        2              110, 'out_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 839045), 'out_df_shape': (2, 3), 'out_df_head':           quantity  defects  production_time
    product                                     
    Widget A       125        5              270
    ...
    product                                     
    Widget A       125        5              270
    Widget B        75        3              205, 'total_time': datetime.timedelta(microseconds=8813)}
...
```
    ...
    {'step_name': 'filter_products',
     'step_description': 'Exclude products which are Widget C',
     'in_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 851928),
     'in_df_shape': (5, 5),
     ...
     3       104  Widget C        20        0               80
     4       105  Widget B        45        2              110,
     'out_time': datetime.datetime(2026, 9, 14, 12, 30, 44, 852409),
     'out_df_shape': (4, 5),
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L39"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def StepMeta(
    step_name:str, step_description:str, in_time:datetime.datetime, in_df_shape:tuple, in_df_head:object,
    in_df_sample:object, in_df_tail:object, out_time:datetime.datetime, out_df_shape:tuple, out_df_head:object,
    out_df_sample:object, out_df_tail:object, total_time:datetime.timedelta
)->None:
```
...
```
    ...
    StepMeta(step_name='filter_products', step_description='Exclude products which are Widget C', in_time=datetime.datetime(2026, 9, 14, 12, 30, 44, 897277), in_df_shape=(5, 5), in_df_head=   order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150, in_df_sample=   order_id   product  quantity  defects  production_time
    1       102  Widget B        30        1               95
    ...
    3       104  Widget C        20        0               80
    4       105  Widget B        45        2              110
    0       101  Widget A        50        2              120, in_df_tail=   order_id   product  quantity  defects  production_time
    2       103  Widget A        75        3              150
    3       104  Widget C        20        0               80
    4       105  Widget B        45        2              110, out_time=datetime.datetime(2026, 9, 14, 12, 30, 44, 897946), out_df_shape=(4, 5), out_df_head=   order_id   product  quantity  defects  production_time
    0       101  Widget A        50        2              120
    1       102  Widget B        30        1               95
    2       103  Widget A        75        3              150, out_df_sample=   order_id   product  quantity  defects  production_time
    4       105  Widget B        45        2              110
...
```
    ...
    Start: 2026-09-14 12:30:44.897277
    End: 2026-09-14 12:30:44.897946

------------------------------------------------------------------------

<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L82"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L91"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L94"
target="_blank" style="float:right; font-size:smaller">source</a>
...
The display helpers print head, sample, and tail separately, so they
work with both pandas and eager Polars DataFrames without conversion.
[`print_sample_from_meta_dict`](https://MIS-Analytics.github.io/mis_analytics/etl.html#print_sample_from_meta_dict)
selects the input or output previews with `mode`;
[`display_sample_from_df`](https://MIS-Analytics.github.io/mis_analytics/etl.html#display_sample_from_df)
samples a DataFrame directly and prints it rather than returning a
combined DataFrame.

------------------------------------------------------------------------

<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L101"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def print_sample_from_meta_dict(
    step_meta:__main__.StepMeta, mode:str='in'
):
```
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L107"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L118"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L140"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L143"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L156"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/MIS-Analytics/mis_analytics/blob/main/mis_analytics/etl.py#L165"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    *************** filter_products ***************
    ...
    Start: 2026-09-14 12:30:45.689253
      End: 2026-09-14 12:30:45.690299
...
preview = df.pipe(take_rows, 4, vrbs=True).pipe(take_rows, 2, vrbs=True)
assert preview.shape == (2, df.shape[1])
preview
```
    ...
    *************** filter_products ***************
    ...
    Start: 2026-09-14 12:30:45.716039
      End: 2026-09-14 12:30:45.717331
    ...
    *************** aggregate_by_product ***************
    ...
    Start: 2026-09-14 12:30:45.723587
      End: 2026-09-14 12:30:45.733836
    ...
    *************** take_rows ***************
    ...
    Start: 2026-09-14 12:30:45.740618
      End: 2026-09-14 12:30:45.741166
    ...
    *************** take_rows ***************
    ...
    Start: 2026-09-14 12:30:45.746451
      End: 2026-09-14 12:30:45.746912
